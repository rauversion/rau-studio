...
const translations: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    "Pantalla": "Screen",
    "Ventana": "Window",
    "Pantalla o ventana": "Screen or window",
    "Pantalla / ventana": "Screen / window",
    "Fuentes en Program": "Sources in Program",
    "Cámara predeterminada": "Default camera",
    "Cámara activa": "Camera active",
    "Pantalla o ventana activa": "Screen or window active",
    "Elegir pantalla o ventana": "Choose screen or window",
    "Cambiar pantalla o ventana": "Change screen or window",
    "Activa": "Active",
    "Activa una cámara o elige una pantalla o ventana": "Enable a camera or choose a screen or window",
    "No se recibió video de la pantalla o ventana seleccionada.": "No video was received from the selected screen or window.",
    "El selector del sistema permite compartir una pantalla completa o una ventana de aplicación.":
      "The system picker lets you share an entire screen or an application window.",
    "Selecciona una pantalla": "Select a screen",
    "Refrescar fuentes": "Refresh sources",
    "Para el Preview, macOS abrirá su selector: elige la misma pantalla seleccionada aquí.":
      "For Preview, macOS will open its picker: choose the same screen selected here.",
    "Espejar fuente": "Mirror source",
    "Preparando fuente visual...": "Preparing visual source...",
    ...
    "Libre · mover en Preview": "Free · move in Preview",
